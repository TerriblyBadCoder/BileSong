...
public class BloodParticle<T extends ParticleEffect> extends SpriteBillboardParticle {
    float addToAngle = 0.0f;
    SpriteProvider spr;
    protected BloodParticle(ClientWorld clientWorld, double d, double e, double f, SpriteProvider spriteProvider, double xd, double yd, double zd) {
