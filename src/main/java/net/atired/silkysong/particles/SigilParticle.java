...
public class SigilParticle<T extends ParryParticleEffect> extends SpriteBillboardParticle {
    private final Vec3d direction;
    private float yaw;
    private SpriteProvider provider;
    private float pitch;
    protected SigilParticle(ClientWorld clientWorld, double d, double e, double f, SpriteProvider spriteProvider, double xd, double yd, double zd, ParryParticleEffect effect, SpriteProvider provider) {
        ...
        dir = dir.normalize();
        this.velocityX = dir.x*0.02;
        this.velocityY = dir.y*0.02;
        this.velocityZ = dir.z*0.02;
    ...
    public void tick() {
        ...
        this.yaw = (float)Math.atan2(dir.x, dir.z);
        this.scale += ((float) this.age /this.maxAge)/8f;
        super.tick();
    ...
    public static class Factory implements ParticleFactory<ParryParticleEffect> {
        ...
        public Particle createParticle(ParryParticleEffect particleType, ClientWorld level, double x, double y, double z,
            ...
            return new SigilParticle<>(level, x, y, z, this.sprites, dx, dy, dz,particleType,sprites);
        }
    }
}
